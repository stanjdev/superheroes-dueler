...
def create_armor():
    armor = [
        ...
        "Obamacare",
        "Thick Goo"]
    name = armor[random.randint(0, len(armor) - 1)]
...
def create_hero(max_strength=100, weapons=False, armor=False, health=False):
...
def create_set():
    ...
    hero_set = {'weapons': abilities, 'armor': armor}
    return hero_set
...
def test_hero_defense_standard_deviation():
    ...
    for _ in range(number_tests):
        defense = willow_waffle.defend(10)
